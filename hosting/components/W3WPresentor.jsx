...
export default function W3Wpresentor({ readOnly }) {
  const { w3wLoc, setw3wLoc } = useAuthStore();
      ...
      <div className="flex flex-col mt-2">
        ...
        <div className="mt-1 flex rounded-md shadow-sm">
          <input
            ...
            disabled={readOnly}
            value={w3wLoc[0]}
            onChange={(e) => setw3wLoc([e.target.value, w3wLoc[1], w3wLoc[2]])}
          ...
          <input
            ...
            disabled={readOnly}
            value={w3wLoc[1]}
            onChange={(e) => setw3wLoc([w3wLoc[0], e.target.value, w3wLoc[2]])}
            className="block w-1/3 mr-2 text-center rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200 sm:text-sm sm:leading-6"
          />
          <input
            type="text"
            ...
            disabled={readOnly}
            value={w3wLoc[2]}
            onChange={(e) => setw3wLoc([w3wLoc[0], w3wLoc[1], e.target.value])}
